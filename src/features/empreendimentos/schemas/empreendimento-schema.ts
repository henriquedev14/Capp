...
export const empreendimentoSchema = z.object({
  ...
  // qualquer tipologia. Pedido pelo Henrique em 11/08/2026.
  precoFixoEletrico: z.string().optional(),
  precoFixoHidraulico: z.string().optional(),
  precoFixoQdc: z.string().optional(),
