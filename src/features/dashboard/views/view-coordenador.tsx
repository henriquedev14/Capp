  ...
  return <div className="flex flex-col gap-5">
    ...
    {aba === "engenharia" && <>
      ...
      <div className="grid gap-4 xl:grid-cols-[1.35fr_1fr]">
        <Card>
          <CardHeader className="border-b"><CardTitle className="text-[15px]">Distribuição de carga por disciplina</CardTitle><p className="text-xs text-muted-foreground">Compare pontos de complexidade, não quantidade bruta de empreendimentos.</p></CardHeader>
