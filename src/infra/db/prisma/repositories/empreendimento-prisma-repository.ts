  ...
  async create(
    ...
    const record = await prisma.empreendimento.create({
      data: {
        ...
        precoFixoEletrico: data.precoFixoEletrico,
        precoFixoHidraulico: data.precoFixoHidraulico,
        precoFixoQdc: data.precoFixoQdc,
  ...
  async update(
    ...
    const record = await prisma.empreendimento.update({
      ...
      data: {
        ...
        ...(data.precoFixoEletrico !== undefined && { precoFixoEletrico: data.precoFixoEletrico }),
        ...(data.precoFixoHidraulico !== undefined && { precoFixoHidraulico: data.precoFixoHidraulico }),
        ...(data.precoFixoQdc !== undefined && { precoFixoQdc: data.precoFixoQdc }),
...
function toDomain(record: PrismaEmpreendimento): Empreendimento {
  return {
    ...
    precoFixoEletrico: record.precoFixoEletrico != null ? Number(record.precoFixoEletrico) : null,
    precoFixoHidraulico: record.precoFixoHidraulico != null ? Number(record.precoFixoHidraulico) : null,
    precoFixoQdc: record.precoFixoQdc != null ? Number(record.precoFixoQdc) : null,
